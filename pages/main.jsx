            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-6 text-center">
                        <button className="btn-primary main-buttons" onClick={()=>alert("Hello")}>Marketing Management</button>
                    </div>
                    <div className="col-md-6 text-center">
                        <button className="btn-warning main-buttons">Finance Management</button>
                    </div>
                </div>
                <div className="row">
                    <div className="col-md-6 text-center">
                        <button className="btn-info main-buttons">Staff Management</button>
                    </div>
                    <div className="col-md-6 text-center">
                        <button className="btn-success main-buttons">Admin Management</button>
                    </div>
                </div>
